...
export const metadata = {
  title: 'About | Devmhimran - Software Developer',
  description:
    'Learn more about Mahmud Hasan Imran, a software developer specializing in Next.js, React, and Express.js, with expertise in building modern web applications.',
  keywords: [
    'Mahmud Hasan Imran',
    'Devmhimran about',
  ...
  openGraph: {
    ...
    title: 'About | Devmhimran - Software Developer',
    description:
      'Learn more about Mahmud Hasan Imran, a software developer specializing in Next.js, React, and Express.js.',
    url: 'https://www.devmhimran.com/about',
    images: [
      {
        url: 'https://www.devmhimran.com/og-about.jpg',
        width: 1280,
        height: 769,
        alt: 'Mahmud Hasan Imran - About Page',
      },
    ],
  ...
  twitter: {
    ...
    description:
      'Learn more about Mahmud Hasan Imran, a software developer specializing in Next.js, React, and Express.js.',
    images: ['https://www.devmhimran.com/og-about.jpg'],
  },
        ...
        <div>
          ...
          <div className='space-y-6'>
            <p className='text-lg/8 text-custom-tertiary'>
              Hi there, I&apos; Mahmud Hasan Imran. I&apos;m a dedicated
              software developer with a passion for crafting innovative
              solutions using Next.js, React, and Express.js.
            </p>
            <p className='text-lg/8 text-custom-tertiary'>
              I&apos;m currently working with Tutors Finland Oy, a Finland-based
              company, where I&apos;m contributing to Nedu AI—an AI-powered job
              platform. Nedu AI features smart profiles that users can create
              and edit via an AI chatbot, alongside intelligent job matching and
            ...
            <p className='text-lg/8 text-custom-tertiary'>
              ...
              developing LocalPress, a subscription-based WordPress theme
              powered by PHP. Beyond that, I&apos;ve completed over 20 freelance
              projects, mostly leveraging Next.js and React.js, with a few
              websites built using WordPress and Elementor. No matter the
